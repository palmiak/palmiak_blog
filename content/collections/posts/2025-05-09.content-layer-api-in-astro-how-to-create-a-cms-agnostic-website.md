...
content:
  ...
  -
    ...
    content:
      -
        type: text
        text: "I wrote a few articles lately about how to connect Astro with different CMSs - the truth is, after creating the first article, the only thing I'm doing (at least in Astro) is just editing the "
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: ' file. Let me show you an example of how the file looked for Flotiq versus the one for Keystatic:'
  -
    type: codeBlock
    attrs:
      language: null
  ...
  -
    ...
    content:
      -
        type: text
        text: "So, they do differ. One is using an API, and the second one is using Mdoc files. But what is important - I'm able to map the variables here and make sure they are the same type."
  -
    type: paragraph
    content:
      -
